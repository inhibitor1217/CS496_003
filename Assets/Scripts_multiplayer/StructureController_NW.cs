...
public class StructureController_NW : NetworkBehaviour {
    ...
    StructuresLocationController_NW structureLocationController;

    public bool isAlive = true;

    private MasterController_NW master;
    ...
    public virtual void Start () {
        ...
        structureLocationController = structureControllerObject.GetComponent<StructuresLocationController_NW>();
        ...
        master = GameObject.FindGameObjectWithTag("MasterController").GetComponent(typeof(MasterController_NW)) as MasterController_NW;
