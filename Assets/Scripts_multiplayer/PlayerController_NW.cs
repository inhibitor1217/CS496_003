...
public class PlayerController_NW : NetworkBehaviour {
    ...
    */
    ...
    MirrorController_NW mc;

    // 전체 좌표 정보를 들고있는 컨트롤러 참조용
    public StructuresLocationController_NW structureLocationController;
    ...
    private void OnDestroy() {
        GameManager_NW gm = GameObject.FindGameObjectWithTag("GameManager").GetComponent(typeof(GameManager_NW)) as GameManager_NW;
        gm.GameOver();
    }
    ...
    // 미러컨트롤러 설정
    public void setMirrorController(MirrorController_NW mirrorController)
    {
        mc = mirrorController;
    }
