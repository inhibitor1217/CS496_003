...
public class PlayerFacingObjectController_NW : MonoBehaviour {

    public PlayerController_NW pc;

    TurretController_NW tc;
    ...
    private void OnTriggerStay(Collider other)
    {
        ...
        if (other.gameObject.tag == "Mirror")
        {
            ...
            // 해당 거울의 컨트롤러를 얻어옴
            mc = other.gameObject.GetComponent<MirrorController_NW>();
        ...
        {
            // 해당 터렛의 컨트롤러를 얻어옴
            tc = other.gameObject.GetComponentInChildren<TurretController_NW>();
